<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Master/Site.Master" AutoEventWireup="true" CodeBehind="KNew.aspx.cs" Inherits="BoatRental.Pages.Master.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="input-form">
        <asp:FormView ID="KundFormView" runat="server"
            ...
            DefaultMode="Insert"
            InsertMethod="KundFormView_InsertItem">
            <InsertItemTemplate>
        
                <div>Namn:</div> <asp:TextBox ID="NamnTextBox" runat="server" Text='<%# BindItem.Namn %>' MaxLength="30"></asp:TextBox>
                <div>Address:</div> <asp:TextBox ID="AddressTextBox" runat="server" Text='<%# BindItem.Address %>' MaxLength="20"></asp:TextBox>
                <div>Telefonnummer:</div> <asp:TextBox ID="TelefonnummerTextBox" runat="server" Text='<%# BindItem.Telefonnummer %>' MaxLength="16"></asp:TextBox>
                <div>Mail:</div> <asp:TextBox ID="MailTextBox" runat="server" Text='<%# BindItem.E_Mail %>' MaxLength="50"></asp:TextBox>
